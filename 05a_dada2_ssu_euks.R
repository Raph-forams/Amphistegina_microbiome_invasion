...
# Try alternative Loess function: https://github.com/chassenr/Tutorials/blob/master/Dada2_workshop_UniHB/loessErrfun2.R
# (see also: https://github.com/benjjneb/dada2/issues/1307)
...
# Continue with: dada2_ssu_3rd_run_euks.R
